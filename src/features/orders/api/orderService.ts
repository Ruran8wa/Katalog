import { orders, products, variants } from '@/shared/mocks/db'
import type { Order, OrderItem, OrderWithDetails } from '@/features/orders/types/order'
import { deriveStockStatus } from '@/shared/utils/stockStatus'
import { requireAuthenticatedUser } from '@/features/auth/api/authService'
